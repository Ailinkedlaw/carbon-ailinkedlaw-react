...
<Canvas>
  <Story id="components-pageheader--with-buttons" />
</Canvas>
...
<Canvas>
  <Story id="components-pageheader--with-tabs" />
</Canvas>
...
<Canvas>
  <Story id="components-pageheader--with-actions-toolbar" />
</Canvas>
...
<Canvas>
  <Story
    id="components-pageheader--with-breadcrumb-actions-toolbar-only"
  />
</Canvas>
...
<Canvas>
  <Story id="components-pageheader--with-title" />
</Canvas>
...
<Canvas>
  <Story id="components-pageheader--with-breadcrumbs" />
</Canvas>
...
<Canvas>
  <Story id="components-pageheader--with-tags" />
</Canvas>
...
<Canvas>
  <Story id="components-pageheader--with-tabs-and-tags" />
</Canvas>
...
<Canvas>
  <Story id="components-pageheader--with-subtitle" />
</Canvas>
...
<Canvas>
  <Story id="components-pageheader--with-summary-details" />
</Canvas>
