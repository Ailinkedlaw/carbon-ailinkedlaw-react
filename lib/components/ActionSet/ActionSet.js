...
var ActionSetButton = /*#__PURE__*/React__default["default"].forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.Button, _rollupPluginBabelHelpers["extends"]({}, rest, {
    isExpressive: true,
    className: cx__default["default"](className, ["".concat(blockClass, "__action-button"), _rollupPluginBabelHelpers.defineProperty({}, "".concat(blockClass, "__action-button--ghost"), kind === 'ghost' || kind === 'danger--ghost')]),
    disabled: disabled || loading || false,
    kind: kind,
    ref: ref
  }), label, loading && (_InlineLoading || (_InlineLoading = /*#__PURE__*/React__default["default"].createElement(react.InlineLoading, null))));
});
ActionSetButton.displayName = 'ActionSetButton';
ActionSetButton.propTypes = _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, react.Button.propTypes), {}, {
...
var ActionSet = /*#__PURE__*/React__default["default"].forwardRef(function (_ref3, ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(react.ButtonSet, _rollupPluginBabelHelpers["extends"]({}, rest, {
    className: cx__default["default"](blockClass, className, (_cx = {}, _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(blockClass, "--row-single"), !stacking && buttons.length === 1), _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(blockClass, "--row-double"), !stacking && buttons.length === 2), _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(blockClass, "--row-triple"), !stacking && buttons.length === 3), _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(blockClass, "--row-quadruple"), !stacking && buttons.length >= 4), _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(blockClass, "--stacking"), stacking), _cx), "".concat(blockClass, "--").concat(size)),
    ref: ref,
    role: "presentation",
    stacked: stacking
...
ActionSet.propTypes = {
   ...
   */
  actions: propsHelper.allPropTypes([ActionSet.validateActions(), PropTypes__default["default"].arrayOf(PropTypes__default["default"].shape(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, react.Button.propTypes), {}, {
    kind: PropTypes__default["default"].oneOf(['ghost', 'danger--ghost', 'secondary', 'danger', 'primary']),
    label: PropTypes__default["default"].string,
    loading: PropTypes__default["default"].bool,
